...
function LoadData(props) {
  ...
  const handleSubmit = (event) => {
    ...
    fetch('http://127.0.0.1:8000/upload/load_data/upload/', {
      //http://0.0.0.0:8001/ http://3.92.188.34:8001/upload/load_data/upload/
      method: 'POST',
      body: formData,
    })
      .then((response) => {
  ...
  return (
    <ModalContainer title="Load data">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <br />
        <br />
        <button type="submit" disabled={!table || !file}>
          Upload
        </button>
      </form>
